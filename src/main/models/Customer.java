...
public class Customer {
    ...
    /**
     * Creates a new {@link main.models.Customer} instance.
     *
     ...
     */
    public Customer(final int id, final String name, final Address ad, final String tel){
        this.customerID = id;
     ...
     * @param tel  the customer telephone
     */
    public Customer(final String name, final Address ad, final String tel){
        this.customerName = name;
        this.address = ad;
        this.telephoneNumber = tel;
    }
     ...
     */
    public Customer(int customerID, String customerName, Address address, String telephoneNumber, Date createdOn, Date updatedOn) {
